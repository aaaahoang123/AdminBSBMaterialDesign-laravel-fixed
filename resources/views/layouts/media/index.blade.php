...
@section('extra-css')
    <link rel="stylesheet" href="{{asset('bsbmd/plugins/light-gallery/css/lightgallery.css')}}">
@endsection
...
@section('extra-script')
    <script src="{{asset('bsbmd/plugins/light-gallery/js/lightgallery-all.js')}}"></script>
    <script src="{{asset('bsbmd/js/pages/medias/image-gallery.js')}}"></script>
@endsection
