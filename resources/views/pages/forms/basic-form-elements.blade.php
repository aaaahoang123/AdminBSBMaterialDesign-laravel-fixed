...
@section('extra-script')
    <script type="text/javascript" src="{{asset('assets/plugins/autosize/autosize.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/plugins/momentjs/moment.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/pages/forms/basic-form-elements.js')}}"></script>
@endsection
