...
@section('extra-css')
    ...
    <link rel="stylesheet" href="{{asset('assets/plugins/multi-select/css/multi-select.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/plugins/jquery-spinner/css/bootstrap-spinner.min.css')}}">
...
@section('extra-script')
    <script type="text/javascript" src="{{asset('assets/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('assets/plugins/multi-select/js/jquery.multi-select.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/plugins/jquery-spinner/js/jquery.spinner.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/plugins/nouislider/nouislider.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/pages/forms/advanced-form-elements.js')}}"></script>
@endsection
