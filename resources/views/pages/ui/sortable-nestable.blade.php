...
@section('extra-css')
    <link rel="stylesheet" href="/assets/plugins/nestable/jquery-nestable.min.css">
@endsection
...
@section('extra-script')
    <script type="text/javascript" src="/assets/plugins/nestable/jquery.nestable.min.js"></script>
    <script type="text/javascript" src="/assets/js/pages/ui/sortable-nestable.js"></script>
@endsection
