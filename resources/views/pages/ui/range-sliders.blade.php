...
@section('extra-css')
    ...
    <link rel="stylesheet" href="{{asset('assets/plugins/ion-rangeslider/css/ion.rangeSlider.skinFlat.min.css')}}">
@endsection
...
@section('extra-script')
    <script type="text/javascript" src="{{asset('assets/plugins/ion-rangeslider/js/ion.rangeSlider.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/pages/ui/range-sliders.js')}}"></script>
@endsection
