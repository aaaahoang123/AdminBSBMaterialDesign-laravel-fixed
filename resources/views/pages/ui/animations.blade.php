        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <img src="{{asset('assets/images/animation-bg.jpg')}}" class="js-animating-object img-responsive">
...
@section('extra-script')
    <script type="text/javascript" src="{{asset('assets/js/pages/ui/animations.js')}}"></script>
@endsection
