...
@section('extra-script')
    ...
    <script type="text/javascript" src="/assets/plugins/jquery-sparkline/jquery.sparkline.js"></script>
    <script type="text/javascript" src="/assets/js/pages/widgets/infobox/infobox-2.js"></script>
@endsection
