...
@section('extra-script')
    ...
    <script type="text/javascript" src="{{asset('assets/plugins/flot-charts/jquery.flot.resize.min.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('assets/js/pages/charts/flot.js')}}"></script>
@endsection
